...
baseUrl = "https://www.fema.gov/api/open/v2/HazardMitigationAssistanceMitigatedProperties?"
...
outFile.write('{"HazardMitigationAssistanceMitigatedProperties":[')
...
print("END " + str(datetime.now()) + ", " + str(len(my_data['HazardMitigationAssistanceMitigatedProperties'])) + " records in file")
inFile.close()
